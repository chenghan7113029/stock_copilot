...
- **And** `002594` 在浅情景 DCF 可用时毕业；`002027` 在 `cycle_position` + 周期方法可用时毕业
- **Note**：诚实层由 `add-v2-honesty-degrade` 落地；P1/P2 见 `add-value-v2-prototype-methods`；EV/NBV、军工订单仍属后续 Phase
