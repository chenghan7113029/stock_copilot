...
**真正还没 apply 的**，目前是：价值 V2 专用方法（P4+）、飞书常看推送、K 线形态、布林带。
T-1 MOS 与 V2 P1–P3（比亚迪/分众/中船）在 `feature/apply-mos-and-value-v2-methods` 推进中。
...
| `add-value-v2-prototype-methods` | value V2 · T-4～T-12 | 专用方法总立项：P1 比亚迪情景 → P2 分众/Cyclical → P3 军工 → P4 保险 → P5 华测 | apply 中 · P1–P3 完成 |
